...
const FUTBOLISTAS = [
  ...
  'Willyrex','ElRichMC','MikeCrack',
  'Davoo Xeneize','MrBeast','BobiCraft','Conterstine',
  ...
  'Gastón','Cam/Zaikku','Instagram',
  'Doki Doki','Monika(Doki)','Yuri(Doki)',
  'Sayori(Doki)','Natsuki(Doki)',
  'VicioLand','Roblox','LUKI',
  'Lucky(perro de hernán)','Gay','Criminalística',
  'Fútbol','BOCA JUNIORS',
  'Brookhaven','Roleplay','Kira',
  'L (Death Note)','Goku',
  'Javier Milei','Donald Trump','Mauricio Macri',
  'Génesis','Geometry Dash',
  'One Piece','Perry el ortitorrico', 'Plantas vs Zombies',
  'Haxball', 'Steven Universe', 'Chavo del 8', 'DC Comics',
  'Marvel', 'Hora de aventuras', 'Meme Maker', 'Gartic Phone',
  'Calabaza luminosa', 'Guerra', 'Argentina', 'Brasil', 'Paraguay',
  ...
  'Pollera', 'Naruto', 'Dragon Ball', 'Clash Royale', 'Undertale',
  'Five Nights at Freddy's','Shrek','Bob Esponja','Ben 10',
  'Herobrine','Discord','IMPOSTOR','Fantasma','Toy Story','Cars',
  'Intensamente (película)','Los Simpson','Momo (streamer)',
  'Copa Mundial','Computadora','Celular','Teclado','Mochila',
  'Slenderman','Jeff The Killer','Recreo','Educación Física',
  'Enano','Ninja','Pirata','Vaquero','Casino'		
];
